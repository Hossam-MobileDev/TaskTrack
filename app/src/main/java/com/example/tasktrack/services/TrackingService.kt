...
import com.example.tasktrack.constants.Constants.Companion.ACTION_STOP_SERVICE
import com.example.tasktrack.constants.Constants.Companion.FASTEST_LOCATION_UPDATE_INTERVAL
import com.example.tasktrack.constants.Constants.Companion.LOCATION_UPDATE_INTERVAL
import com.example.tasktrack.constants.Constants.Companion.NOTIFICATION_CHANNEL_ID
import com.example.tasktrack.constants.Constants.Companion.NOTIFICATION_CHANNEL_NAME
import com.example.tasktrack.constants.Constants.Companion.NOTIFICATION_ID
...
class TrackingService : LifecycleService() {
    ...
    private fun startForegroundService() {
        ...
        timeRunInSeconds.observe(this, Observer {   if(!serviceKilled) {
